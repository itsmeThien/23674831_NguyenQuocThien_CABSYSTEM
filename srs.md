...
| TC_AUTH_002 | Kiểm tra chức năng đăng ký | **[POS]** Đăng ký tài khoản Customer với thông tin hợp lệ | User đang ở màn hình đăng ký | 1. Mở đăng ký<br>2. Nhập đầy đủ thông tin<br>3. Nhấn Đăng ký | Name: `Nguyen Van A`<br>Email: `customer01@gmail.com`<br>Password: `Customer@123`<br>Role: `CUSTOMER` | Tài khoản được tạo thành công | High |
